...
**note about pilot A:** I had some issues with data analysis so far, but I got my pilot to run and have my data, as well as have the analysis code.
**link to my current analysis code pipeline:**
**link to my data:**
